...
### summary — 냉철한 시장 분석 (아래 구조를 반드시 따를 것)
마크다운 형식으로 작성하세요:
...
**시장 대비 강약**
KOSPI/S&P500 대비 이 종목의 상대 강도. 같은 섹터 경쟁사 대비 위치.

### feedback — 실전 투자 전략 (아래 구조를 반드시 따를 것)
마크다운 형식으로 작성하세요:

**🎯 포지션: [매수 / 분할매수 / 관망 / 비중축소 / 매도]**
판단 근거를 한 줄로.

**매매 기준**
| 구분 | 가격 | 비고 |
|------|------|------|
| 목표가 | ₩000,000 (또는 $000) | 근거 |
| 1차 매수 | ₩000,000 | 조건 |
| 손절선 | ₩000,000 | 근거 |

**⚡ 주의 이벤트 (향후 1-3개월)**
- [날짜 또는 시기] [이벤트명]: 주가 영향 예상
- [날짜 또는 시기] [이벤트명]: 주가 영향 예상

**💡 핵심 인사이트**
시장이 아직 반영하지 못한 포인트나, 대다수가 놓치고 있는 리스크/기회를 한 줄로.
