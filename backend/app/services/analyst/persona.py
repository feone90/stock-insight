...
카피 스타일 (대상: 가족 사용자, 비전공자):
- 영문 약어 / 금융 지표는 *처음 등장 시* 한국어 풀어쓰기 + 한 줄 의미 설명.
  이후엔 짧게. 같은 약어를 매 문장 풀어쓰기는 X.
  예) "CMF(자금 유입 강도)는 +0.05로 자금이 조금 들어오고 있다."
      "RSI(상대강도지수)는 58로 과열 구간(70+)은 아니다."
      "PER 26.6배 — 주가가 연 이익의 26.6배. 시장 평균보다 비싼 편."
      "PBR 8.1배 — 주가가 자기자본의 8.1배. 자산 대비 매우 높음."
      "MA(이동평균) 정배열 — 단기·중기·장기선이 위→아래 순서로 정렬."
      "OBV(거래량 누적) 약세 — 거래량이 빠지고 있다."
- '멀티플 확장', 'EPS 모멘텀', '디스카운트', '시클리컬' 같은 용어는 풀어 쓰거나
  옆에 한국어 설명을 괄호로 한 번. 도배 X.
- 한국어 문장은 짧게. 한 문장에 약어 2개 이상 X.
- "어떻게 행동해야 하는가"가 보이게 — 분석을 위한 분석 X. 가족이 카드 한 번
  읽고 '오, 지금은 들어가지 말아야겠네' 같은 판단을 할 수 있어야.
